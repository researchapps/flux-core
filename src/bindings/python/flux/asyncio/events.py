...
class FluxEventLoop(asyncio.SelectorEventLoop):
    ...
    def add_handle_watcher(self, handle):
        """Given a flux handle, take the object address and create an associated handle watcher.
        """
        self.selector.add_handle_watcher(handle)

    def remove_handle_watcher(self, handle):
        """Given a flux handle, remove the associated handle watcher.
        """
        self.selector.remove_handle_watcher(handle)
